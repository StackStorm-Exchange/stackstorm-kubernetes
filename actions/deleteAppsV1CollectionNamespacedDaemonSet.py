...
class deleteAppsV1CollectionNamespacedDaemonSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1/namespaces/{namespace}/daemonsets".format(  # noqa pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
