...
class listAutoscalingV2beta1HorizontalPodAutoscalerForAllNamespaces(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/autoscaling/v2beta1/horizontalpodautoscalers".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "get"
