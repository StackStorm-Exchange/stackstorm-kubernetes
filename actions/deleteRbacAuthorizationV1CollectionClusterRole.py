...
class deleteRbacAuthorizationV1CollectionClusterRole(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1/clusterroles".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "delete"
