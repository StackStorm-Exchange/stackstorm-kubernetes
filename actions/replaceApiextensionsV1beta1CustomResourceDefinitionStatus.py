...
class replaceApiextensionsV1beta1CustomResourceDefinitionStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{name}/status".format(  # noqa pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
