...
class replaceStorageV1beta1VolumeAttachment(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/storage.k8s.io/v1beta1/volumeattachments/{name}".format(  # noqa pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
