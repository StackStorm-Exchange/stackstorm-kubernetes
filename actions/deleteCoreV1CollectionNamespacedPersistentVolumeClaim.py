...
class deleteCoreV1CollectionNamespacedPersistentVolumeClaim(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/persistentvolumeclaims".format(  # pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
