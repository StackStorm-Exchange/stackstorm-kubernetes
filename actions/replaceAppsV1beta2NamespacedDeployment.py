...
class replaceAppsV1beta2NamespacedDeployment(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/deployments/{name}".format(  # noqa pylint: disable=line-too-long
