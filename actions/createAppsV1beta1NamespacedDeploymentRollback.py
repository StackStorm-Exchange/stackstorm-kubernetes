...
class createAppsV1beta1NamespacedDeploymentRollback(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta1/namespaces/{namespace}/deployments/{name}/rollback".format(  # noqa pylint: disable=line-too-long
