...
class readPolicyV1beta1NamespacedPodDisruptionBudget(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}".format(name=name, namespace=namespace )
        args['method'] = "get"
