...
class replaceApiregistrationV1beta1APIService(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apiregistration.k8s.io/v1beta1/apiservices/{name}".format(  # noqa pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
