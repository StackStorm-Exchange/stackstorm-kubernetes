...
class deleteNetworkingV1CollectionNamespacedNetworkPolicy(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies".format(  # noqa pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
