...
class replaceSettingsV1alpha1NamespacedPodPreset(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}".format(  # noqa pylint: disable=line-too-long
