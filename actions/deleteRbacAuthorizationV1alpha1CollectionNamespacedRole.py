...
class deleteRbacAuthorizationV1alpha1CollectionNamespacedRole(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles".format(  # pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
