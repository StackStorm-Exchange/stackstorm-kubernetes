...
class replaceAppsV1beta2NamespacedStatefulSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/statefulsets/{name}".format(  # noqa pylint: disable=line-too-long
