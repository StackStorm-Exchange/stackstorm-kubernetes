...
class deleteExtensionsV1beta1CollectionNamespacedHorizontalPodAutoscaler(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/horizontalpodautoscalers".format(  # pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
