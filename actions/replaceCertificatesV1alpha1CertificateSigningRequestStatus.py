...
class replaceCertificatesV1alpha1CertificateSigningRequestStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/certificates.k8s.io/v1alpha1/certificatesigningrequests/{name}/status".format(  # pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
