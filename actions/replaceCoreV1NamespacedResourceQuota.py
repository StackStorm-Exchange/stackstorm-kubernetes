...
class replaceCoreV1NamespacedResourceQuota(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/resourcequotas/{name}".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
