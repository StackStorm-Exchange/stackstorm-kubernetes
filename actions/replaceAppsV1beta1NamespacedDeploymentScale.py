...
class replaceAppsV1beta1NamespacedDeploymentScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta1/namespaces/{namespace}/deployments/{name}/scale".format(  # noqa pylint: disable=line-too-long
