...
class replaceCoreV1NamespacedPodTemplate(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/podtemplates/{name}".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
