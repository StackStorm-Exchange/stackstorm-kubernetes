...
class readCoreV1NamespacedResourceQuotaStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/resourcequotas/{name}/status".format(name=name, namespace=namespace )
        args['method'] = "get"
