...
class deleteSettingsV1alpha1CollectionNamespacedPodPreset(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets".format(  # noqa pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
