...
class patchExtensionsV1beta1NamespacedReplicaSetStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}/status".format(body=body, name=name, namespace=namespace )
        args['method'] = "patch"
