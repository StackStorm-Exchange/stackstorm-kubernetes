...
class replaceAppsV1beta2NamespacedDaemonSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}".format(  # noqa pylint: disable=line-too-long
