...
class replaceBatchV1beta1NamespacedCronJob(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}".format(  # noqa pylint: disable=line-too-long
