...
class deleteAdmissionregistrationV1beta1CollectionMutatingWebhookConfiguration(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "delete"
