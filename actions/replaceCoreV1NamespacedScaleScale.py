...
class replaceCoreV1NamespacedScaleScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/replicationcontrollers/{name}/scale".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
