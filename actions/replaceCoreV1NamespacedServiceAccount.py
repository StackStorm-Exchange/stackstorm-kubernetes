...
class replaceCoreV1NamespacedServiceAccount(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/serviceaccounts/{name}".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
