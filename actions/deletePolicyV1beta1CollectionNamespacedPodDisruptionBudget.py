...
class deletePolicyV1beta1CollectionNamespacedPodDisruptionBudget(Action):
    ...
    def run(self,namespace,fieldSelector=None,labelSelector=None,resourceVersion=None,timeoutSeconds=None,watch=None,pretty=None):
        ...
        return myk8s.runAction('deletePolicyV1beta1CollectionNamespacedPodDisruptionBudget', **args)