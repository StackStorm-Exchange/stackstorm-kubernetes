...
class deletePolicyV1beta1CollectionPodSecurityPolicy(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/policy/v1beta1/podsecuritypolicies".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "delete"
