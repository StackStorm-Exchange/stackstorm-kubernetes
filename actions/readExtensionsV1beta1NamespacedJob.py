...
class readExtensionsV1beta1NamespacedJob(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/jobs/{name}".format(name=name, namespace=namespace )
        args['method'] = "get"
