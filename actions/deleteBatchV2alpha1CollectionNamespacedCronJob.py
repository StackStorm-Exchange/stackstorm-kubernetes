...
class deleteBatchV2alpha1CollectionNamespacedCronJob(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/batch/v2alpha1/namespaces/{namespace}/cronjobs".format(  # noqa pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
