...
class replaceAppsV1beta1NamespacedStatefulSetStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta1/namespaces/{namespace}/statefulsets/{name}/status".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
