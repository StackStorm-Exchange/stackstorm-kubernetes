...
class replaceAppsV1beta2NamespacedReplicaSetStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}/status".format(  # noqa pylint: disable=line-too-long
