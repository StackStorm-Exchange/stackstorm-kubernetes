...
class replaceBatchV1beta1NamespacedCronJobStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}/status".format(  # noqa pylint: disable=line-too-long
