...
class listRbacAuthorizationV1beta1RoleBindingForAllNamespaces(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1beta1/rolebindings".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "get"
