...
class replaceBatchV2alpha1NamespacedCronJob(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}".format(  # noqa pylint: disable=line-too-long
