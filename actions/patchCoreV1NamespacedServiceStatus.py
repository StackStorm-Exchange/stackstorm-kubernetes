...
class patchCoreV1NamespacedServiceStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/services/{name}/status".format(body=body, name=name, namespace=namespace )
        args['method'] = "patch"
