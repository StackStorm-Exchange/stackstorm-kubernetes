...
class deleteApiregistrationV1CollectionAPIService(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apiregistration.k8s.io/v1/apiservices".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "delete"
