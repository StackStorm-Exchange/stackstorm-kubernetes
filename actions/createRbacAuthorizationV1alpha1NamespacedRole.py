...
class createRbacAuthorizationV1alpha1NamespacedRole(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles".format(body=body, namespace=namespace )
        args['method'] = "post"
