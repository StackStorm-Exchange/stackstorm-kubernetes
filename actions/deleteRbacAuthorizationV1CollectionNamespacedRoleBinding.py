...
class deleteRbacAuthorizationV1CollectionNamespacedRoleBinding(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings".format(  # noqa pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
