...
class replaceRbacAuthorizationV1beta1ClusterRoleBinding(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/{name}".format(  # noqa pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
