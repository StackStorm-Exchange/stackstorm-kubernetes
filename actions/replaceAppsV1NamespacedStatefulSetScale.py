...
class replaceAppsV1NamespacedStatefulSetScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1/namespaces/{namespace}/statefulsets/{name}/scale".format(  # noqa pylint: disable=line-too-long
