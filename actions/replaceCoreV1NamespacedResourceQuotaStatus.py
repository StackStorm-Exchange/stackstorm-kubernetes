...
class replaceCoreV1NamespacedResourceQuotaStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/resourcequotas/{name}/status".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
