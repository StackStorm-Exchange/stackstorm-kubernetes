...
class replaceRbacAuthorizationV1alpha1ClusterRoleBinding(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}".format(  # pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
