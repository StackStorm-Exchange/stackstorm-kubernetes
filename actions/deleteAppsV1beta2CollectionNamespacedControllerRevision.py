...
class deleteAppsV1beta2CollectionNamespacedControllerRevision(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions".format(  # noqa pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
