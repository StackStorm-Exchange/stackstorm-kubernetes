...
class readExtensionsV1beta1NamespacedJobStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/jobs/{name}/status".format(name=name, namespace=namespace )
        args['method'] = "get"
