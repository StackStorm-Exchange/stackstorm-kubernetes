...
class replaceCertificatesV1alpha1CertificateSigningRequest(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/certificates.k8s.io/v1alpha1/certificatesigningrequests/{name}".format(body=body, name=name )
        args['method'] = "put"
