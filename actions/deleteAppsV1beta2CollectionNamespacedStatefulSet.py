...
class deleteAppsV1beta2CollectionNamespacedStatefulSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/statefulsets".format(  # noqa pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
