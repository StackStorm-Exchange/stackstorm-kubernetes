...
class replaceExtensionsV1beta1NamespacedIngressStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/ingresses/{name}/status".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
