...
class deleteRbacAuthorizationV1alpha1NamespacedRoleBinding(Action):
    ...
    def run(self,body,name,namespace,config_override=None,gracePeriodSeconds=None,orphanDependents=None,pretty=None):
        ...
        return (True, myk8s.runAction('deleteRbacAuthorizationV1alpha1NamespacedRoleBinding', **args))
