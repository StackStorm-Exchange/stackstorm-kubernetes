...
class deleteExtensionsV1beta1NamespacedIngress(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/ingresses/{name}".format(body=body, name=name, namespace=namespace )
        args['method'] = "delete"
