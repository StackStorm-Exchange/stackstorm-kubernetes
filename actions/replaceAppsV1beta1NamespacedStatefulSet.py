...
class replaceAppsV1beta1NamespacedStatefulSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta1/namespaces/{namespace}/statefulsets/{name}".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
