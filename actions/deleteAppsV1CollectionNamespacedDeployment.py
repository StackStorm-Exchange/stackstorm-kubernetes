...
class deleteAppsV1CollectionNamespacedDeployment(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1/namespaces/{namespace}/deployments".format(  # noqa pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
