...
class deleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscaler(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers".format(  # pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
