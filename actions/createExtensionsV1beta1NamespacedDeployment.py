...
class createExtensionsV1beta1NamespacedDeployment(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/deployments".format(body=body, namespace=namespace )
        args['method'] = "post"
