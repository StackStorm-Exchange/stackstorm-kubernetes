...
class replaceAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status".format(  # noqa pylint: disable=line-too-long
