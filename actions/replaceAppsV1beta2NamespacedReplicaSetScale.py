...
class replaceAppsV1beta2NamespacedReplicaSetScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}/scale".format(  # noqa pylint: disable=line-too-long
