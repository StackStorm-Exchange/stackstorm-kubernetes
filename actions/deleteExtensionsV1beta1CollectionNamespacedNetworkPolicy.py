...
class deleteExtensionsV1beta1CollectionNamespacedNetworkPolicy(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies".format(  # pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
