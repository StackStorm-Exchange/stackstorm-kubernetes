...
class replaceExtensionsV1beta1NamespacedDaemonSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/daemonsets/{name}".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
