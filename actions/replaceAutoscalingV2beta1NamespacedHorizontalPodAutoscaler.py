...
class replaceAutoscalingV2beta1NamespacedHorizontalPodAutoscaler(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}".format(  # noqa pylint: disable=line-too-long
