...
class deleteExtensionsV1beta1CollectionNamespacedReplicaSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/replicasets".format(  # pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
