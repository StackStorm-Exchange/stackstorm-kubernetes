...
class listRbacAuthorizationV1RoleBindingForAllNamespaces(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1/rolebindings".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "get"
