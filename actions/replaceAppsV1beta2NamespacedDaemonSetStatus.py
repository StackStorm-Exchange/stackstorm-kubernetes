...
class replaceAppsV1beta2NamespacedDaemonSetStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}/status".format(  # noqa pylint: disable=line-too-long
