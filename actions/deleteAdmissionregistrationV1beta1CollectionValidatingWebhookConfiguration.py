...
class deleteAdmissionregistrationV1beta1CollectionValidatingWebhookConfiguration(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "delete"
