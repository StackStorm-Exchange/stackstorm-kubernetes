...
class deleteExtensionsV1beta1CollectionNamespacedDeployment(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/deployments".format(  # pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
