...
class replaceAppsV1NamespacedDeploymentScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1/namespaces/{namespace}/deployments/{name}/scale".format(  # noqa pylint: disable=line-too-long
