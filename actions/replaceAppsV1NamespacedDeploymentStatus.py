...
class replaceAppsV1NamespacedDeploymentStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1/namespaces/{namespace}/deployments/{name}/status".format(  # noqa pylint: disable=line-too-long
