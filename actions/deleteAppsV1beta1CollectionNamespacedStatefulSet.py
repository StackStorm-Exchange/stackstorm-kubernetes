...
class deleteAppsV1beta1CollectionNamespacedStatefulSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta1/namespaces/{namespace}/statefulsets".format(  # pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
