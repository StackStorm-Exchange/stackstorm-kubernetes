...
class deleteRbacAuthorizationV1alpha1CollectionClusterRole(Action):
    ...
    def run(self,config_override=None,fieldSelector=None,labelSelector=None,resourceVersion=None,timeoutSeconds=None,watch=None,pretty=None):
        ...
        return (True, myk8s.runAction('deleteRbacAuthorizationV1alpha1CollectionClusterRole', **args))
