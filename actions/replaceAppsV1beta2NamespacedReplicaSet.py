...
class replaceAppsV1beta2NamespacedReplicaSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}".format(  # noqa pylint: disable=line-too-long
