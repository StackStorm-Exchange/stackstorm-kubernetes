...
class replaceCoreV1NamespacedReplicationController(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/replicationcontrollers/{name}".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
