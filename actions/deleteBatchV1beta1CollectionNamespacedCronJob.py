...
class deleteBatchV1beta1CollectionNamespacedCronJob(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/batch/v1beta1/namespaces/{namespace}/cronjobs".format(  # noqa pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
