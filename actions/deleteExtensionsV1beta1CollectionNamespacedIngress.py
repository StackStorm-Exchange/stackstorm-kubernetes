...
class deleteExtensionsV1beta1CollectionNamespacedIngress(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/ingresses".format(  # pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
