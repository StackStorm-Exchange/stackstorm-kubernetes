...
class deleteAutoscalingV1NamespacedHorizontalPodAutoscaler(Action):
    ...
    def run(self,body,name,namespace,config_override=None,gracePeriodSeconds=None,orphanDependents=None,pretty=None):
        ...
        return (True, myk8s.runAction('deleteAutoscalingV1NamespacedHorizontalPodAutoscaler', **args))
