...
class replaceEventsV1beta1NamespacedEvent(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}".format(  # noqa pylint: disable=line-too-long
