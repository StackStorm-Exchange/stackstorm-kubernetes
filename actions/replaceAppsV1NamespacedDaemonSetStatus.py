...
class replaceAppsV1NamespacedDaemonSetStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1/namespaces/{namespace}/daemonsets/{name}/status".format(  # noqa pylint: disable=line-too-long
