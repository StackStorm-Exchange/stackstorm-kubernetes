...
class deleteRbacAuthorizationV1beta1CollectionNamespacedRole(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles".format(  # noqa pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
