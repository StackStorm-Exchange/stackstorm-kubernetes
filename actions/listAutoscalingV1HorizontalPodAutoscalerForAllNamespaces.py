...
class listAutoscalingV1HorizontalPodAutoscalerForAllNamespaces(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/autoscaling/v1/horizontalpodautoscalers".format(  # pylint: disable=line-too-long
            )
        args['method'] = "get"
