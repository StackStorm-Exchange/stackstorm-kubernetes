...
class replaceStorageV1alpha1VolumeAttachment(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/storage.k8s.io/v1alpha1/volumeattachments/{name}".format(  # noqa pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
