...
class createCoreV1NamespacedReplicationController(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/replicationcontrollers".format(body=body, namespace=namespace )
        args['method'] = "post"
