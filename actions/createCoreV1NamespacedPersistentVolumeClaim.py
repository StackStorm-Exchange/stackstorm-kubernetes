...
class createCoreV1NamespacedPersistentVolumeClaim(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/persistentvolumeclaims".format(body=body, namespace=namespace )
        args['method'] = "post"
