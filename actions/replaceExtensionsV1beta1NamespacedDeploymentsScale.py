...
class replaceExtensionsV1beta1NamespacedDeploymentsScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/deployments/{name}/scale".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
