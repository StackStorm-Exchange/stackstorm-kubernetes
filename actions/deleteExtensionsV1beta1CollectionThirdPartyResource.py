...
class deleteExtensionsV1beta1CollectionThirdPartyResource(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/thirdpartyresources".format(  # pylint: disable=line-too-long
            )
        args['method'] = "delete"
