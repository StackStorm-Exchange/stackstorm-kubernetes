...
class replaceCoreV1NamespacedReplicationControllerStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/replicationcontrollers/{name}/status".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
