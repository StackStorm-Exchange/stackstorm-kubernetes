...
class deleteRbacAuthorizationV1beta1CollectionClusterRoleBinding(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "delete"
