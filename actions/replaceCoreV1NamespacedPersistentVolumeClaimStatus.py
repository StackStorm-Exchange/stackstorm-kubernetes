...
class replaceCoreV1NamespacedPersistentVolumeClaimStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/persistentvolumeclaims/{name}/status".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
