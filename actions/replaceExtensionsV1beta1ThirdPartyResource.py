...
class replaceExtensionsV1beta1ThirdPartyResource(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/thirdpartyresources/{name}".format(  # pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
