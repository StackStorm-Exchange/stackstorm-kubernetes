...
class deleteCertificatesV1alpha1CollectionCertificateSigningRequest(Action):
    ...
    def run(self,config_override=None,fieldSelector=None,labelSelector=None,resourceVersion=None,timeoutSeconds=None,watch=None,pretty=None):
        ...
        return (True, myk8s.runAction('deleteCertificatesV1alpha1CollectionCertificateSigningRequest', **args))
