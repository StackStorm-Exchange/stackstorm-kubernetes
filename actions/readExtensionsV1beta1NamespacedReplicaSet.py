...
class readExtensionsV1beta1NamespacedReplicaSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}".format(name=name, namespace=namespace )
        args['method'] = "get"
