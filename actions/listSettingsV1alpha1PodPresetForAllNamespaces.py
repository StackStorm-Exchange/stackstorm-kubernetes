...
class listSettingsV1alpha1PodPresetForAllNamespaces(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/settings.k8s.io/v1alpha1/podpresets".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "get"
