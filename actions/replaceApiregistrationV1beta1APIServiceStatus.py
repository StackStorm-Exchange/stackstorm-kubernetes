...
class replaceApiregistrationV1beta1APIServiceStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apiregistration.k8s.io/v1beta1/apiservices/{name}/status".format(  # noqa pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
