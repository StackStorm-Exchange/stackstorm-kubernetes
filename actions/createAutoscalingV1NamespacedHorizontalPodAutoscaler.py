...
class createAutoscalingV1NamespacedHorizontalPodAutoscaler(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers".format(body=body, namespace=namespace )
        args['method'] = "post"
