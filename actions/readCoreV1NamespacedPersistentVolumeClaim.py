...
class readCoreV1NamespacedPersistentVolumeClaim(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/persistentvolumeclaims/{name}".format(name=name, namespace=namespace )
        args['method'] = "get"
