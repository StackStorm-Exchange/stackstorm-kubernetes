...
class replaceAppsV1beta2NamespacedStatefulSetScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/statefulsets/{name}/scale".format(  # noqa pylint: disable=line-too-long
