...
class deleteCoreV1CollectionNamespacedServiceAccount(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/serviceaccounts".format(  # pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
