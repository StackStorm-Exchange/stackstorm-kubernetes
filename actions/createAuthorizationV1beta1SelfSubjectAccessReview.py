...
class createAuthorizationV1beta1SelfSubjectAccessReview(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/authorization.k8s.io/v1beta1/selfsubjectaccessreviews".format(  # pylint: disable=line-too-long
            body=body)
        args['method'] = "post"
