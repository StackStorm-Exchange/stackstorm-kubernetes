...
class createCoreV1NamespacedBindingBinding(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/pods/{name}/binding".format(body=body, name=name, namespace=namespace )
        args['method'] = "post"
