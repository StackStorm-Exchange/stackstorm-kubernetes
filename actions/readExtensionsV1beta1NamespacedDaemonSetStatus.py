...
class readExtensionsV1beta1NamespacedDaemonSetStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/daemonsets/{name}/status".format(name=name, namespace=namespace )
        args['method'] = "get"
