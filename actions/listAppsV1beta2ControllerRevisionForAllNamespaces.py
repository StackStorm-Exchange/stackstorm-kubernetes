...
class listAppsV1beta2ControllerRevisionForAllNamespaces(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/controllerrevisions".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "get"
