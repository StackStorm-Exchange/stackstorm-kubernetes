...
class deleteExtensionsV1beta1CollectionNamespacedDaemonSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/daemonsets".format(  # pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
