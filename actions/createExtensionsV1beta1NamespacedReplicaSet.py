...
class createExtensionsV1beta1NamespacedReplicaSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/replicasets".format(body=body, namespace=namespace )
        args['method'] = "post"
