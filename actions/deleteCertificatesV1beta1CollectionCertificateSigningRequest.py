...
class deleteCertificatesV1beta1CollectionCertificateSigningRequest(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/certificates.k8s.io/v1beta1/certificatesigningrequests".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "delete"
