...
class replaceAppsV1NamespacedStatefulSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1/namespaces/{namespace}/statefulsets/{name}".format(  # noqa pylint: disable=line-too-long
