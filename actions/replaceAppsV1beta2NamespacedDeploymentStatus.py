...
class replaceAppsV1beta2NamespacedDeploymentStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/deployments/{name}/status".format(  # noqa pylint: disable=line-too-long
