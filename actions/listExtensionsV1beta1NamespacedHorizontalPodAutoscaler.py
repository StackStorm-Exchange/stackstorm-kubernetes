...
class listExtensionsV1beta1NamespacedHorizontalPodAutoscaler(Action):
    ...
    def run(self,namespace,config_override=None,fieldSelector=None,labelSelector=None,resourceVersion=None,timeoutSeconds=None,watch=None,pretty=None):
        ...
        return (True, myk8s.runAction('listExtensionsV1beta1NamespacedHorizontalPodAutoscaler', **args))
