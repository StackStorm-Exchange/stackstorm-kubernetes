...
class replaceAppsV1beta2NamespacedDeploymentScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/deployments/{name}/scale".format(  # noqa pylint: disable=line-too-long
