...
class replaceAppsV1NamespacedReplicaSetScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1/namespaces/{namespace}/replicasets/{name}/scale".format(  # noqa pylint: disable=line-too-long
