...
class replaceAppsV1beta2NamespacedControllerRevision(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/controllerrevisions/{name}".format(  # noqa pylint: disable=line-too-long
