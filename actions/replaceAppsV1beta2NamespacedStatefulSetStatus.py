...
class replaceAppsV1beta2NamespacedStatefulSetStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta2/namespaces/{namespace}/statefulsets/{name}/status".format(  # noqa pylint: disable=line-too-long
