...
class replaceExtensionsV1beta1NamespacedReplicaSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
