...
class replaceCertificatesV1beta1CertificateSigningRequest(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}".format(  # noqa pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
