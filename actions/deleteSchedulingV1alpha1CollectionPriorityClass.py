...
class deleteSchedulingV1alpha1CollectionPriorityClass(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/scheduling.k8s.io/v1alpha1/priorityclasses".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "delete"
