...
class listRbacAuthorizationV1alpha1RoleBindingForAllNamespaces(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1alpha1/rolebindings".format(  # pylint: disable=line-too-long
            )
        args['method'] = "get"
