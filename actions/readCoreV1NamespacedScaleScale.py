...
class readCoreV1NamespacedScaleScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "api/v1/namespaces/{namespace}/replicationcontrollers/{name}/scale".format(name=name, namespace=namespace )
        args['method'] = "get"
