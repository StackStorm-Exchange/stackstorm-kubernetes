...
class deleteApiextensionsV1beta1CollectionCustomResourceDefinition(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "delete"
