...
class replaceExtensionsV1beta1NamespacedReplicasetsScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}/scale".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
