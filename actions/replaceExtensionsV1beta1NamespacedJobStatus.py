...
class replaceExtensionsV1beta1NamespacedJobStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/jobs/{name}/status".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
