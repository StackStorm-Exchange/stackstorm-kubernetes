...
class deleteAppsV1CollectionNamespacedReplicaSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1/namespaces/{namespace}/replicasets".format(  # noqa pylint: disable=line-too-long
            namespace=namespace)
        args['method'] = "delete"
