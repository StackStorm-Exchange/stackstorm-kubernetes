...
class listExtensionsV1beta1HorizontalPodAutoscalerForAllNamespaces(Action):
    ...
    def run(self,config_override=None,fieldSelector=None,labelSelector=None,pretty=None,resourceVersion=None,timeoutSeconds=None,watch=None):
        ...
        return (True, myk8s.runAction('listExtensionsV1beta1HorizontalPodAutoscalerForAllNamespaces', **args))
