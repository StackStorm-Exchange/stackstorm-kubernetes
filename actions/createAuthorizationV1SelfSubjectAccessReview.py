...
class createAuthorizationV1SelfSubjectAccessReview(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/authorization.k8s.io/v1/selfsubjectaccessreviews".format(  # noqa pylint: disable=line-too-long
            body=body)
        args['method'] = "post"
