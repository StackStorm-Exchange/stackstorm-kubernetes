...
class readPolicyV1beta1NamespacedPodDisruptionBudgetStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status".format(name=name, namespace=namespace )
        args['method'] = "get"
