...
class replaceAppsV1beta1NamespacedDeployment(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta1/namespaces/{namespace}/deployments/{name}".format(  # noqa pylint: disable=line-too-long
