...
class replaceRbacAuthorizationV1NamespacedRole(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}".format(  # noqa pylint: disable=line-too-long
