...
class replaceExtensionsV1beta1PodSecurityPolicy(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/podsecuritypolicies/{name}".format(  # noqa pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
