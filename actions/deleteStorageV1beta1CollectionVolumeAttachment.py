...
class deleteStorageV1beta1CollectionVolumeAttachment(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/storage.k8s.io/v1beta1/volumeattachments".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "delete"
