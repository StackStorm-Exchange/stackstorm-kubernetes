...
class deleteRbacAuthorizationV1alpha1CollectionClusterRole(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1alpha1/clusterroles".format(  # pylint: disable=line-too-long
            )
        args['method'] = "delete"
