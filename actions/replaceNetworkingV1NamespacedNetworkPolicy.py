...
class replaceNetworkingV1NamespacedNetworkPolicy(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies/{name}".format(  # noqa pylint: disable=line-too-long
