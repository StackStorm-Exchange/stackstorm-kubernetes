...
class readExtensionsV1beta1NamespacedHorizontalPodAutoscaler(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}".format(name=name, namespace=namespace )
        args['method'] = "get"
