...
class replaceRbacAuthorizationV1beta1NamespacedRoleBinding(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}".format(  # noqa pylint: disable=line-too-long
