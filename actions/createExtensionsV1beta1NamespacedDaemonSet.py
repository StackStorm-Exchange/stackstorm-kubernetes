...
class createExtensionsV1beta1NamespacedDaemonSet(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/daemonsets".format(body=body, namespace=namespace )
        args['method'] = "post"
