...
class deleteRbacAuthorizationV1alpha1CollectionClusterRoleBinding(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings".format(  # pylint: disable=line-too-long
            )
        args['method'] = "delete"
