...
class replaceCertificatesV1beta1CertificateSigningRequestStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/status".format(  # noqa pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
