...
class readExtensionsV1beta1NamespacedReplicaSetStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/extensions/v1beta1/namespaces/{namespace}/replicasets/{name}/status".format(name=name, namespace=namespace )
        args['method'] = "get"
