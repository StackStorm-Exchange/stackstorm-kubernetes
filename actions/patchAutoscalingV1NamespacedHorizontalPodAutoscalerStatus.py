...
class patchAutoscalingV1NamespacedHorizontalPodAutoscalerStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status".format(  # pylint: disable=line-too-long
