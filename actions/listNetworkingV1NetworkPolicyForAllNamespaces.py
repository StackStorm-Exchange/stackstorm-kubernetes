...
class listNetworkingV1NetworkPolicyForAllNamespaces(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/networking.k8s.io/v1/networkpolicies".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "get"
