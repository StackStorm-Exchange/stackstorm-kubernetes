...
class readAutoscalingV1NamespacedHorizontalPodAutoscaler(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}".format(name=name, namespace=namespace )
        args['method'] = "get"
