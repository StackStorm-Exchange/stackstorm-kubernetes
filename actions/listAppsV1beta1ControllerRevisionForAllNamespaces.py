...
class listAppsV1beta1ControllerRevisionForAllNamespaces(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta1/controllerrevisions".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "get"
