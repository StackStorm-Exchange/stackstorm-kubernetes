...
class replaceBatchV2alpha1NamespacedCronJobStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}/status".format(  # noqa pylint: disable=line-too-long
