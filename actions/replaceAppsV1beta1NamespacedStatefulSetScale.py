...
class replaceAppsV1beta1NamespacedStatefulSetScale(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1beta1/namespaces/{namespace}/statefulsets/{name}/scale".format(  # noqa pylint: disable=line-too-long
