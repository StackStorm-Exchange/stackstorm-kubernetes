...
class replaceRbacAuthorizationV1alpha1NamespacedRole(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles/{name}".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
