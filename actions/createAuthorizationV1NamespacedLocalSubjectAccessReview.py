...
class createAuthorizationV1NamespacedLocalSubjectAccessReview(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/authorization.k8s.io/v1/namespaces/{namespace}/localsubjectaccessreviews".format(  # noqa pylint: disable=line-too-long
