...
class deleteAdmissionregistrationV1alpha1CollectionExternalAdmissionHookConfiguration(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/admissionregistration.k8s.io/v1alpha1/externaladmissionhookconfigurations".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "delete"
