...
class getAdmissionregistrationV1beta1APIResources(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/admissionregistration.k8s.io/v1beta1/".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "get"
