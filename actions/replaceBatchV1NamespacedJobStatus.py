...
class replaceBatchV1NamespacedJobStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/batch/v1/namespaces/{namespace}/jobs/{name}/status".format(body=body, name=name, namespace=namespace )
        args['method'] = "put"
