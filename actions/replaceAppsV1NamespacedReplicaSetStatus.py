...
class replaceAppsV1NamespacedReplicaSetStatus(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1/namespaces/{namespace}/replicasets/{name}/status".format(  # noqa pylint: disable=line-too-long
