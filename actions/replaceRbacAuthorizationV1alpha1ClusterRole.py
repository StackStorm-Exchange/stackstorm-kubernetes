...
class replaceRbacAuthorizationV1alpha1ClusterRole(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}".format(  # pylint: disable=line-too-long
            body=body, name=name)
        args['method'] = "put"
