...
class getAdmissionregistrationV1alpha1APIResources(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/admissionregistration.k8s.io/v1alpha1/".format(  # noqa pylint: disable=line-too-long
            )
        args['method'] = "get"
