...
class replaceAppsV1NamespacedControllerRevision(K8sClient):
    ...
    def run(
        ...
        args['url'] = "apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}".format(  # noqa pylint: disable=line-too-long
